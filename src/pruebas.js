...
function howManyMovies(moviesArray) {
    ...
    const stevenMovies = moviesArray.map((movie) => {
...
/* function howManyMovies(moviesArray) {
    const stevenMovies = moviesArray.map((movie) => {
    if (movie.director == "Steven Spielberg" && movie.genre == "Drama")
      {return movie;} else if (movie.director !== "Steven Spielberg") {
        return null
      }
  });
...
function howManyMovies(movies) {
  ...
  /* mi prueba de Average con Average
...
let final= scoresAverage(movies);
console.log(final);
